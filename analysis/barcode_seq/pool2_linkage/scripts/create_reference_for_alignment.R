...
## --------------------------------------------------------------------------------------------------------------------------------------------------
library_annotations_files <- c(didi = "../annotations/insert_annotations.tsv")
output_file <- "../data/bowtie2_reference/didi_linkage.fasta"
...
library_annotations_files %>% 
  ...
  arrange(-insert_num) %>% 
  write_tsv("../annotations/insert_annotations/didi_linkage.tsv") %>%
  arrange(insert_num) %>% 
