...
rule all:
    input:
        ...
        '../data/motif_counts/vv_motifs.tsv.gz',
        '../data/motif_counts/non_v_motifs.tsv.gz',
...
rule get_vv_motif_counts:
    """Get the frequency of destabilizing in CDS"""
    input:
        notebook = "find_vv_motifs.ipynb"
    output:
        motif_file = '../data/motif_counts/vv_motifs.tsv.gz',
    params:
        transcript_seq = '../data/gencode/gencode.v32.canonical_ccds.fa',
    log:
        '../data/motif_counts/vv_motifs_counts.log'
    conda:
        'base'
    shell:
        """
...
rule get_non_v_motif_counts:
    """Get the frequency of destabilizing in CDS"""
    input:
        notebook = "find_non_v_motifs.ipynb"
    output:
        motif_file = '../data/motif_counts/non_v_motifs.tsv.gz',
    params:
        transcript_seq = '../data/gencode/gencode.v32.canonical_ccds.fa',
    log:
        '../data/motif_counts/non_v_motifs_counts.log'
    conda:
        'base'
    shell:
        """
